<html>
<head>
	<title>672017081_672017207</title>
</head>
<body>
	<form action="updateDB.php" method="POST" enctype="multipart/form-data">
		...
		<tr>
			<td height="40">&nbsp;</td>
			<td>&nbsp;</td>
			<td><font size="4" color="blue"><b>Update</b></font></td>
		</tr>
		<tr>
			<td height="40">&nbsp;</td>
			<td>Book Tittle</td>
			<td><input type="text" name="Book_Tittle" size="40"></td>
		</tr>
		<tr>
			<td height="40">&nbsp;</td>
			<td>Author Name</td>
		...
		<tr>
			...
			<td><input type="submit" name="submit" value="Update"></a>&nbsp;&nbsp;&nbsp;
				<td height="60">&nbsp;</td>
				<td>&nbsp;</td>
				<td><a href="view_data.php" target="_blank"><input type="button" class="view" value="view data"/></a>&nbsp;&nbsp;&nbsp;
		</tr>
		</table>
	</form>
</body>
